...
export interface CardStats {
  ...
  trait: string;                // trait key, e.g. "noble" — categorical (correct/wrong)
...
export const CARD_STATS: Record<string, CardStats> = {
  ...
  firecracker: {
    ...
    description: "A fiery troop that launches crackling projectiles at nearby enemies",
  },
  magic_archer: {
    name: "Magic Archer",
    rarity: "Rare",
    ...
    troopRole: "Ranged",
    releaseDate: "2026-01-01",
    description: "Fires magical arrows that pierce through multiple enemies",
  },
  // ─── Epic Troops ────────────────────────────────────────────────────────────
  baby_dragon: {
    name: "Baby Dragon",
  ...
  goblin_cage: {
    ...
    troopRole: null,
    releaseDate: "2026-01-01",
    description: "A goblin-guarded cage that releases its prisoner to fight nearby enemies",
  },
  // ─── Legendary Troops ───────────────────────────────────────────────────────
  mega_knight: {
    name: "Mega Knight",
  ...
  boss_bandit: {
    ...
    troopRole: "Melee",
    releaseDate: "2026-01-01",
    description: "A fearsome bandit boss who strikes with overwhelming force",
  },
  // ─── Buildings ──────────────────────────────────────────────────────────────
  mortar: {
    name: "Mortar",
